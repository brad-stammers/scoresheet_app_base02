class BattingsController < ApplicationController
  ...
  def destroy
    @batting.destroy
    respond_to do |format|
      format.html { redirect_to inning_battings_url(@batting.inning_id), notice: 'Batting was successfully destroyed.' }
  ...
  private
    ...
    def batting_params
      params.require(:batting).permit(:batting_team, :overs, :runs, :wickets, :byes, :leg_byes, :inning_id)
    end
end
